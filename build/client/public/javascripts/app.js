...
require.register("locales/nl.json", function(exports, require, module) {
module.exports = {
    "calendar list title": "Kalenders",
    "sync settings button label": "Synchronisatie",
    ...
    "screen confirm title": "Weet je het zeker?",
    "screen confirm description": "De verandering die je hier gemaakt hebt zal verloren gaan.",
    "screen confirm yes button": "Niet opslaan",
    "screen confirm no button": "Annuleer",
