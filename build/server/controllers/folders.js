...
var File, Folder, KB, MB, archiver, async, cozydb, findFolder, folderContentComparatorFactory, getFolderPath, jade, log, moment, normalizePath, path, pathHelpers, sharing, updateParents;
...
module.exports.modify = function(req, res, next) {
  ...
  updateFoldersAndFiles = function(folders, files) {
    return updateParents.flush(function() {
...
module.exports.zip = function(req, res, next) {
  ...
  makeZip = function(zipName, files) {
    ...
    req.on('close', function() {
      if (typeof (archive != null ? archive.abort : void 0) === 'function') {
        archive.abort();
      }
